...
public class CommonMethods extends BaseClass {
	 ...
	 * 
	 * @author yunuskazan
	 * @param WebElement elementSendkey, WebElement elementUpload, WebElement
	 *                   elementDisplayed, String filePath;
	 */

	public static void uploadFile(WebElement elementSendkey, WebElement elementUpload, WebElement elementDisplayed,
			String filePath) {
	...
	public static void ConfirmAlert(WebElement element, String text) throws InterruptedException {

		waitForElementBeClickable(element, 10);
		...
		if (alertText.equals(text)) {
			...
			System.out.println(alert.getText() + " is the text of alert.");

		} else if (!alertText.equals(text)) {

			alert.dismiss();
			
			System.out.println(alert.getText() + " is NOT the text of alert");
			

		} else {

			System.out.println(alert.getText() + " NO alert text ");
		}
	...
	/**
	 * @author yunuskazan
	 * this method will enable to send text to alert box if it's enable and confirm alert or if box is not enable to send text then dismiss it.
	 * @param element
	 * @param text
	 * @throws InterruptedException
	 */
	public static void PromptAlert(WebElement element, WebElement box, String text) throws InterruptedException {
		...
		if (alertText.equals(text)) {
			...
			System.out.println(alertText+ " is the text of alert.");
	...
	/**
	 *this method will allow to take a screen shot of the page as .png extension picture file in TestNG frameworks.
	 * @author yunuskazan 
	 * @param fileName
	 * @return String destination of the file
	 */
	...
	/**
	 * 
	 * this method will allow to take a screen shot for cucumber hooks class to report test as byte data types 
	 * @author yunuskazan  
	 * @return screen as byte[] data type.
	 */

	public static byte[] takeScreenshotByte() {
